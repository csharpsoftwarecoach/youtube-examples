...
{
    /// <summary> Defines extension methods for <see cref="WeakReference{T}"/>. </summary>
    public static class WeakReferenceExtensions
    {
        ...
        public static T TargetOrDefault<T>(this WeakReference<T> weakReference) where T : class
        {
